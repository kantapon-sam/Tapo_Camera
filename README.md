...
- กด `User / Pass` ใต้กล้องเพื่อดูชื่อผู้ใช้ แล้วติ๊ก `Show password` เพื่อแสดงรหัสผ่าน รองรับทั้งบัญชีที่ตั้งค่าแยกและบัญชีใน RTSP URL
- ในหน้าต่าง `+ Add Camera` สามารถดูบัญชีที่เลือกใช้จากกล้องเดิม และติ๊ก `Show password` เพื่อตรวจรหัสผ่านก่อนเพิ่มได้
- กด `Delete` ใต้กล้อง แล้วยืนยันเพื่อลบออกจากรายการและไฟล์ตั้งค่าต้นทาง เปิดโปรแกรมใหม่แล้วกล้องจะไม่กลับมา เพิ่มกล้องกลับได้ด้วย `+ Add Camera`
- ให้กด `Stop Record` ก่อนเพิ่มหรือลบกล้อง การลบกล้องจะเก็บวิดีโอเดิมไว้ใน `recordings/` และยังเปิดได้จาก `Playback > Open File`
